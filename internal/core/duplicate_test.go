...
func TestLint_DuplicateSlug(t *testing.T) {
	svc := NewService(&fakeStore{
		tasks: []domain.Task{
			...
			{ID: "6fjangd7kvh3", Slug: "dup", Status: domain.StatusCompleted, FolderStatus: domain.StatusCompleted},
			{ID: "6fjangd7kvh3", Slug: "dup", Status: domain.StatusDeprecated, FolderStatus: domain.StatusDeprecated},
			{ID: "6fjangd7kvh4", Slug: "solo", Status: domain.StatusCompleted, FolderStatus: domain.StatusCompleted},
		},
	})
