...
To load completions in your current shell session:
	...
	source <(tskflwctl completion zsh)

To load completions for every new session, execute once:

#### Linux:

	tskflwctl completion zsh > "${fpath[1]}/_tskflwctl"

#### macOS:

	tskflwctl completion zsh > $(brew --prefix)/share/zsh/site-functions/_tskflwctl

You will need to start a new shell for this setup to take effect.


```
tskflwctl completion zsh [flags]
```
