...
```
  ...
  -c, --columns strings   select columns for -o table/csv/json, comma-separated (-o table when no format is pinned); available: slug,bucket,area,date,findings,open_findings,id
