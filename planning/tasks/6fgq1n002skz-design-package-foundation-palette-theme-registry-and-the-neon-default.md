...
## Reference
Design doc §2,§3,§5 — `planning/research/6fgq1n001pwm-color-palette-and-theming-overhaul.md`. Umbrella: [color-and-design-overhaul-one-coherent-palette-across-every-surface](6ffr4wc01gtv-color-and-design-overhaul-one-coherent-palette-across-every-surface.md).
