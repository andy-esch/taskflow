...
## Reference
Design doc §5, open questions. Depends on the config/selection task. Closes the picker stopgap in [render-the-interactive-picker-inline-not-full-screen-alt-screen](6ffr4wc00dsr-render-the-interactive-picker-inline-not-full-screen-alt-screen.md).
